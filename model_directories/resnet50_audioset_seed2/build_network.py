...
def build_net(include_rep_in_model=True, 
    ...
    resume_path = '/om4/group/mcdermott/user/jfeather/projects/robust_audio_networks/model_training_directory/audio_rep_training_cochleagram_1/fmri_paper_more_seeds/standard_training_audioset_decay_lr_seed2/c7e82e1d-06df-4f85-8b62-bb2a51145cbc/5_checkpoint.pt'
    ...
    TASK_LOSS_PARAMS={}
    # Only include audioset in the task loss
