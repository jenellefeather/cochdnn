...
def build_net(include_rep_in_model=True, 
    ...
    resume_path = os.path.join(MODEL_CHECKPOINT_DIR, 'audio_rep_training_cochleagram_1/standard_training_audioset_decay_lr/9442ee31-7775-4e4a-9ff8-12cb54cf32e1/5_checkpoint.pt')
