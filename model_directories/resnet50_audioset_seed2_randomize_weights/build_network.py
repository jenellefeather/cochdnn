...
def build_net(include_rep_in_model=True, 
    ...
    resume_path = os.path.join(MODEL_CHECKPOINT_DIR, 'audio_rep_training_cochleagram_1/fmri_paper_more_seeds/standard_training_audioset_decay_lr_seed2/c7e82e1d-06df-4f85-8b62-bb2a51145cbc/5_checkpoint.pt')
