...
def build_net(include_rep_in_model=True, 
    ...
    resume_path = os.path.join(MODEL_CHECKPOINT_DIR, 'audio_rep_training_cochleagram_1/kell2018_audioset_decay_lr/1629f285-0a2c-4764-beaf-0b9fe11ba2e7/5_checkpoint.pt')
