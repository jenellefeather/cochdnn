...
# cp /om4/group/mcdermott/user/jfeather/projects/robust_audio_networks/robustness/plotting_and_analysis_scripts/measure_layer_activations_pytorch.py .

python -m pdb measure_layer_activations_pytorch.py 'build_network.py'
