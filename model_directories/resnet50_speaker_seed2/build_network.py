...
def build_net(include_rep_in_model=True, 
    ...
    resume_path = os.path.join(MODEL_CHECKPOINT_DIR, 'audio_rep_training_cochleagram_1/fmri_paper_more_seeds/standard_training_speaker_decay_lr_seed2/0afd73b1-92b0-4ace-93c0-3671d7e58b21/5_checkpoint.pt')
